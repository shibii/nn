...
wb wb::pow(int p) const { return {af::pow(w, p), af::pow(b, p)}; }
wb wb::sqrt() const {
...
wb operator*(const wb& lhs, float rhs) { return {lhs.w * rhs, lhs.b * rhs}; }
wb operator*(float lhs, const wb& rhs) { return {rhs.w * lhs, rhs.b * lhs}; }
wb operator/(const wb& lhs, const wb& rhs) {
  return {lhs.w / rhs.w, lhs.b / rhs.b};
}
wb operator/(const wb& lhs, float rhs) { return {lhs.w / rhs, lhs.b / rhs}; }
